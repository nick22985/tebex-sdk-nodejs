...
export class HeadlessApi {
     ...
     */
    public async updateTier (token: string, tierId: string, updateTierRequest?: UpdateTierRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CMSPagesResponse;  }> {
